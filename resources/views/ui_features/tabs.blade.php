              ...
              <div class="tab-content tab-content-vertical">
                <div class="tab-pane fade show active" id="home-2" role="tabpanel" aria-labelledby="home-tab-vertical">
                  <div class="text-center">
                    <img class="me-3 w-25 mb-4" src="../../../../images/samples/300X300/12.html" alt="sample image">
                  </div>
                  <p>
              ...
              <div class="tab-content tab-content-vertical tab-content-vertical-custom">
                <div class="tab-pane fade show active" id="home-3" role="tabpanel" aria-labelledby="home-tab-custom">
                  ...
                  <div class="d-flex mt-4">
                      ...
                      <img src="../../../../images/samples/300x300/4.jpg" class="w-25 h-100 ms-2 rounded" alt="image"/>
                  </div>
                  <p class="mt-4">
        ...
        <div class="card-body">
          ...
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
              <div class="media">
                <img class="me-3 w-25 rounded" src="../../../../images/samples/300x300/12.jpg" alt="sample image">
                <div class="media-body">
            ...
            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
              <div class="media">
                <img class="me-3 w-25 rounded" src="../../../../images/samples/300X300/10.html" alt="sample image">
                <div class="media-body">
