                ...
                <div id="profile-list-left" class="py-2">
                  <div class="card rounded mb-2">
                    <div class="card-body p-3">
                      <div class="media">
                        <img src="../../../../images/faces/face1.jpg" alt="image" class="img-sm me-3 rounded-circle">
                  ...
                  <div class="card rounded mb-2">
                    <div class="card-body p-3">
                      <div class="media">
                        <img src="../../../../images/faces/face2.jpg" alt="image" class="img-sm me-3 rounded-circle">
                        <div class="media-body">
                  ...
                  <div class="card rounded mb-2">
                    <div class="card-body p-3">
                      <div class="media">
                        <img src="../../../../images/faces/face3.jpg" alt="image" class="img-sm me-3 rounded-circle">
                        <div class="media-body">
                  ...
                  <div class="card rounded mb-2">
                    <div class="card-body p-3">
                      <div class="media">
                        <img src="../../../../images/faces/face4.jpg" alt="image" class="img-sm me-3 rounded-circle">
                        <div class="media-body">
              ...
              <div class="bg-dark p-4">
                ...
                <div id="profile-list-right" class="py-2">
                  <div class="card rounded mb-2">
                    <div class="card-body p-3">
                      <div class="media">
                        <img src="../../../../images/faces/face5.jpg" alt="image" class="img-sm me-3 rounded-circle">
                        <div class="media-body">
                  ...
                  <div class="card rounded mb-2">
                    <div class="card-body p-3">
                      <div class="media">
                        <img src="../../../../images/faces/face6.jpg" alt="image" class="img-sm me-3 rounded-circle">
                        <div class="media-body">
                  ...
                  <div class="card rounded mb-2">
                    <div class="card-body p-3">
                      <div class="media">
                        <img src="../../../../images/faces/face7.jpg" alt="image" class="img-sm me-3 rounded-circle">
                        <div class="media-body">
                  ...
                  <div class="card rounded mb-2">
                    <div class="card-body p-3">
                      <div class="media">
                        <img src="../../../../images/faces/face8.jpg" alt="image" class="img-sm me-3 rounded-circle">
                        <div class="media-body">
            ...
            <div class="col-md-6">
              ...
              <div id="dragula-left" class="py-2">
                ...
                <div class="card rounded border mb-2">
                  <div class="card-body p-3">
                    <div class="media">
                      <i class="ti-file icon-sm align-self-center me-3"></i>
                      <div class="media-body">
                ...
                <div class="card rounded border mb-2">
                  <div class="card-body p-3">
                    <div class="media">
                      <i class="ti-upload icon-sm align-self-center me-3"></i>
                      <div class="media-body">
                ...
                <div class="card rounded border mb-2">
                  <div class="card-body p-3">
                    <div class="media">
                      <i class="ti-agenda icon-sm align-self-center me-3"></i>
                      <div class="media-body">
            ...
            <div class="col-md-6">
              ...
              <div id="dragula-right" class="py-2">
                <div class="card rounded border mb-2">
                  <div class="card-body p-3">
                    <div class="media">
                      <i class="ti-user icon-sm align-self-center me-3"></i>
                      <div class="media-body">
                ...
                <div class="card rounded border mb-2">
                  <div class="card-body p-3">
                    <div class="media">
                      <i class="ti-view-grid icon-sm align-self-center me-3"></i>
                      <div class="media-body">
                ...
                <div class="card rounded border mb-2">
                  <div class="card-body p-3">
                    <div class="media">
                      <i class="ti-calendar icon-sm align-self-center me-3"></i>
                      <div class="media-body">
            ...
            <div class="col-md-6">
              ...
              <div id="dragula-event-right" class="py-2">
                <div class="card rounded border mb-2">
                  <div class="card-body p-3">
                    <div class="media">
                      <i class="ti ti-time icon-sm text-success align-self-center me-3"></i>
                      <div class="media-body">
                        <h6 class="mb-1">Project details</h6>
                        <p class="mb-0 text-muted">
                          Get new project details from Greg
