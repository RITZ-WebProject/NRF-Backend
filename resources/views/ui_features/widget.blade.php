            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center pb-3 border-bottom">
                    ...
                    <div class="ms-3">
                        ...
                        <small class="text-muted mb-0"><i class="ti-location-pin me-1"></i>New York City, USA</small>
                    </div>
                ...
                <div class="d-flex align-items-center py-3 border-bottom">
                    ...
                    <div class="ms-3">
                        ...
                        <small class="text-muted mb-0"><i class="ti-location-pin me-1"></i>Florida, USA</small>
                    </div>
                    <i class="ti-plus font-weight-bold ms-auto px-1 py-1 text-success mdi-24px"></i>
                </div>
                <div class="d-flex align-items-center py-3 border-bottom">
                    <img class="img-sm rounded-circle" src="../../../../images/faces/face7.jpg" alt="profile">
                    <div class="ms-3">
                        <h6 class="mb-1">Bruno King</h6>
                        <small class="text-muted mb-0"><i class="ti-location-pin me-1"></i>Arkansas, USA</small>
                    </div>
                    <i class="ti-check font-weight-bold ms-auto px-1 py-1 text-info mdi-24px"></i>
                </div>
                <div class="d-flex align-items-center py-3 border-bottom">
                    ...
                    <div class="ms-3">
                        ...
                        <small class="text-muted mb-0"><i class="ti-location-pin me-1"></i>Arizon, USA</small>
                    </div>
                    <i class="ti-plus font-weight-bold ms-auto px-1 py-1 text-success mdi-24px"></i>
                </div>
                <div class="d-flex align-items-center pt-3">
                    ...
                    <div class="ms-3">
                        ...
                        <small class="text-muted mb-0"><i class="ti-location-pin me-1"></i>Alaska, USA</small>
                    </div>
                    <i class="ti-plus font-weight-bold ms-auto px-1 py-1 text-success mdi-24px"></i>
                </div>
            </div>
