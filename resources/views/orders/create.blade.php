                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" class="form-control" name="discount_price" id="discount_price" placeholder="Discount Price" required>
                                <div class="text-danger form-control-feedback">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" class="form-control" name="total_price" id="total_price" placeholder="Total Price" required>
                                <div class="text-danger form-control-feedback">
