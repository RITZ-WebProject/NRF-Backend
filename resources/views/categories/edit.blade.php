                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" value="{{$category->name}}" id="" placeholder="" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_mm" value="{{$category->name_mm}}" id="" placeholder="" required>
                                <div class="text-danger form-control-feedback">
